...
const file_recommendation_proto_rawDesc = "" +
	"\n" +
	"\x14recommendation.proto\x12\x0erecommendation\"\xdb\x01\n" +
...
var file_recommendation_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
...
func file_recommendation_proto_init() {
	...
	file_recommendation_proto_msgTypes[0].OneofWrappers = []any{}
	file_recommendation_proto_msgTypes[2].OneofWrappers = []any{}
	type x struct{}
